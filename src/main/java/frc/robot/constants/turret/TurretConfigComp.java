...
public class TurretConfigComp extends TurretConfigBase {

    public static TurretConfigComp instance = null;
    public static TurretConfigComp getInstance() {
        if (instance == null) {
            instance = new TurretConfigComp();
        }
        return instance;
    }

    private TurretConfigComp() {}
