...
public class TurretConfigProto extends TurretConfigBase {

    public static TurretConfigProto instance = null;
    public static TurretConfigProto getInstance() {
        if (instance == null) {
            instance = new TurretConfigProto();
        }
        return instance;
    }

    private TurretConfigProto() {}
